...
export class HttpClient {
    ...
    async transaction() {
        throw new LibsqlError("The HTTP client does not support interactive transactions. " +
            'Please use a "libsql:", "ws:" or "wss:" URL to connect to the server over a WebSocket. ' +
            `For more information, please read ${supportedUrlLink}`, "TRANSACTIONS_NOT_SUPPORTED");
    }
    close() {
        this.closed = true;
    }
