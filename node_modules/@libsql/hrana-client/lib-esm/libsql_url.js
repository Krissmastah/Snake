...
export function parseLibsqlUrl(urlStr) {
    ...
    if (url.protocol === "http:") {
        throw new LibsqlUrlParseError('This client does not support "http:" URLs. Please use a "ws:" URL instead.');
    }
    else if (url.protocol === "https:") {
        throw new LibsqlUrlParseError('This client does not support "https:" URLs. Please use a "wss:" URL instead.');
    }
