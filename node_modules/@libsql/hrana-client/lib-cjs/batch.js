...
class BatchStep {
    ...
    * times, we join them with a logical AND. */
    ...
    query(stmt) {
        return this.#add((0, stmt_js_1.stmtToProto)(stmt, true), result_js_1.rowsResultFromProto);
    }
    /** Add a statement that returns at most a single row. */
    queryRow(stmt) {
        return this.#add((0, stmt_js_1.stmtToProto)(stmt, true), result_js_1.rowResultFromProto);
    }
    /** Add a statement returns at most a single value. */
    queryValue(stmt) {
        return this.#add((0, stmt_js_1.stmtToProto)(stmt, true), result_js_1.valueResultFromProto);
    }
    /** Add a statement without returning rows. */
    run(stmt) {
        return this.#add((0, stmt_js_1.stmtToProto)(stmt, false), result_js_1.stmtResultFromProto);
    }
    #add(stmt, fromProto) {
